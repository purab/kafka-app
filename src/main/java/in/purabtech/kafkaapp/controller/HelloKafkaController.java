package in.purabtech.kafkaapp.controller;

import in.purabtech.kafkaapp.pojo.MessageFormat;
...
public class HelloKafkaController {
    ...
    public String hello() throws Exception {
        ...
        IntStream.range(0, messagesPerRequest)
                .forEach(i -> this.template.send(topicName, String.valueOf(i),
                        new MessageFormat("A Practical Advice", i))
                );
    ...
    public void listenAsObject(ConsumerRecord<String, MessageFormat> cr,
                               @Payload MessageFormat payload) {
